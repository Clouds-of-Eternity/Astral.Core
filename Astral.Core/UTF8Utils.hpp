...
inline option<u32> UTF8GetCharPointAt(text utf8, usize index)
{
    ...
    {
        result = ((startingByte & 0b00011111) << 6 + 6 + 6) | ((utf8[index + 1] & 0b00111111) << 6 + 6) | ((utf8[index + 2] & 0b00111111) << 6) | ((utf8[index + 2] & 0b00111111));
    }
    else if ((startingByte & 0b11110000) == 0b11100000)
    {
        result = ((startingByte & 0b00011111) << 6 + 6) | ((utf8[index + 1] & 0b00111111) << 6) | ((utf8[index + 2] & 0b00111111));
    }
